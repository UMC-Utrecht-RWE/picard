...
t4_pipeline <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description Initialize the T4 pipeline with a YAML configuration file.
    ...
    #' @description Clean up files related to the T4 pipeline.
    ...
    #' @description Run the T4 pipeline.
    #' @return NULL
    run = function() {
    ...
    #' @description Delete data generated by the T4 pipeline.
